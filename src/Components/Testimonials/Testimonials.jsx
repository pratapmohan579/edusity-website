...
return (
    <div className='testimonials'>
        <img src={next_icon} alt="" className='naxt-btn'  onClick=
        {slideForward} />
            ...
            <ul>
                <li>
                    ...
                    <p>Choosing to pursue my degree at Edusity was one of 
                        ...
                        to academic excellence have truly exceeded my expectation.</p> 
                </div>
                </li>
            </ul>
            <li>
