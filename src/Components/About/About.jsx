...
const About = ({ setPlayState}) => {
  return (
    <div className='about'>
        ...
        <p>Embark on a transformative educational journry with our
            ...
            education. </p>
            <p>With a focus on innovation, hands-on learning, and personslized 
                mentorship, our programs perpare aspiring educators to make a 
                meaningful impact in claaeooms, schools, and  communities. </p>
                <p>Whether you aspire to become a teacher, admisistrator,
                counselor, or educational leader, our diverse range of programs
                offers the perfect pathway to achieve your goala and unlock your 
